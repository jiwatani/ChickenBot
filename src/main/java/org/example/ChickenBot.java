	...
	public static void main(String[] args) throws IOException {
		...
		slackService.addSlacklet(new Slacklet() {
			...
			public void onDirectMessagePosted(SlackletRequest req, SlackletResponse resp) {
				...
				// メッセージ本文を取得
				String moji = req.getContent();

				if (!(userName.equals("chicken_bot")) && !(moji.contains("しないで")) && !(moji.contains("やらないで"))
						&& !(moji.contains("わないで")) && !(moji.contains("えないで"))) {
					...
					if ((moji.contains("!映画")) || (moji.contains("!おすすめの映画")) || (moji.contains("!オススメの映画")) || (moji.contains("!オススメ映画"))
							|| (moji.contains("！映画")) || (moji.contains("！おすすめの映画")) || (moji.contains("！オススメの映画")) || (moji.contains("！オススメ映画"))) {
					...
					//朝の挨拶
					if ((moji.contains("おはよ")) || (moji.contains("おはー")) || (moji.contains("おは-"))) {
						switch (ran) {
						case 1:
							resp.reply("おはよう！");
							break;
					...
					//お昼の挨拶
					else if ((moji.contains("こんに")) || (moji.contains("こんちゃ")) || (moji.contains("ちわっす"))) {
						switch (ran) {
						case 1:
							resp.reply("こんにちはー！");
							break;
					...
					//夜の挨拶
					else if ((moji.contains("こんば")) || (moji.contains("ばんちゃ"))
							|| (moji.contains("ばんわー")) || (moji.contains("ばんわ-"))) {
						switch (ran) {
						case 1:
							resp.reply("こんばんはー！");
							break;
					...
					//運勢
					else if (moji.contains("!運勢") || (moji.contains("！運勢"))) {
						switch (un) {
						case 1:
							resp.reply("運勢は～～～～～\n--+--+--+--+--+--+--\n--+--+--小吉--+--+--\n--+--+--+--+--+--+--\nコケーーーッ！！(おめでとう！！)");
							break;
					...
					//掃除当番
					else if (moji.contains("!掃除") || (moji.contains("！掃除"))) {
					...
					//割り当てメーカー
					else if (moji.contains("!割り当てメーカー") || (moji.contains("!割り当て"))
							|| (moji.contains("！割り当てメーカー") || (moji.contains("！割り当て")))) {
						if (moji.contains("!割り当て\n") || (moji.contains("!割り当て\n"))
								|| (moji.contains("！割り当てメーカー\n") || (moji.contains("！割り当て\n")))) {
					...
					//割り当てメーカーv2
					else if (moji.contains("!wmv2") || (moji.contains("!wmv2"))
							|| (moji.contains("！wmv2") || (moji.contains("！wmv2")))) {
						if (moji.contains("!wmv2\n") || (moji.contains("!wmv2\n"))
								|| (moji.contains("！wmv2\n") || (moji.contains("！wmv2\n")))) {
			...
			public void onMessagePosted(SlackletRequest req, SlackletResponse resp) {
				...
				if (!(userName.equals("chicken_bot")) && !(moji.contains("しないで")) && !(moji.contains("やらないで"))
					...
					if (moji.contentEquals("！献立") || (moji.contains("!献立")) || (moji.contains("!料理"))
							|| (moji.contains("！料理"))) {

						//配列をランダム処理
						resp.reply(egg);
					}
					else if (Arrays.asList(another).contains(moji)) {
			...
			public void onMentionedMessagePosted(SlackletRequest req, SlackletResponse resp) {
				...
				if (!(userName.equals("chicken_bot")) && !(moji.contains("しないで")) && !(moji.contains("やらないで"))
					...
					//掃除当番
							...
							|| (moji.contains("！掃除当番")) || (moji.contains("！掃除当番"))) {
					...
					else if (moji.contains("!割り当てメーカー") || (moji.contains("!割り当て")) || (moji.contains("！割り当てメーカー") || (moji.contains("！割り当て")))) {
						if (moji.contains("!割り当て\n") || (moji.contains("!割り当て\n")) || (moji.contains("！割り当てメーカー\n") || (moji.contains("！割り当て\n")))) {
